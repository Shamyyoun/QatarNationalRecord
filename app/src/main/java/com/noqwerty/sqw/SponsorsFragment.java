...
import com.noqwerty.sqw.customviews.DividerItemDecoration;
...
public class SponsorsFragment extends Fragment {
    ...
    private void initComponents(View rootView) {
        ...
        recyclerSponsors = (RecyclerView) rootView
                .findViewById(R.id.recycler_sponsors);
        ...
        // customize recycler sponsors
        recyclerSponsors.setLayoutManager(new LinearLayoutManager(activity));
        recyclerSponsors.addItemDecoration(new DividerItemDecoration(activity.getApplicationContext(), LinearLayoutManager.VERTICAL));
        ...
        SponsorsAdapter adapter = new SponsorsAdapter(activity, sponsors,
                R.layout.recycler_sponsors_item);
        recyclerSponsors.setAdapter(adapter);

        // add item click listener
        adapter.setOnItemClickListener(new SponsorsAdapter.OnItemClickListener() {
            @Override
