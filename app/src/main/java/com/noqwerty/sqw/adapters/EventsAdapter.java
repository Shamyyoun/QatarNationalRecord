...
public class EventsAdapter extends AnimatedExpandableListAdapter {
    ...
    public View getRealChildView(int groupPosition, int childPosition,
        ...
        if (convertView == null) {
            ...
            holder.recyclerThumbnails = (RecyclerView) convertView
                    .findViewById(R.id.recycler_thumbnails);

            // customize recycler thumbnails
            LinearLayoutManager layoutManager = new LinearLayoutManager(activity);
            layoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);
            holder.recyclerThumbnails.setLayoutManager(layoutManager);
        ...
        EventThumbnailsAdapter adapter = new EventThumbnailsAdapter(activity,
                event, R.layout.recycler_thumbnails_item);
        holder.recyclerThumbnails.setAdapter(adapter);

        // add item click listener
        adapter.setOnItemClickListener(new EventThumbnailsAdapter.OnItemClickListener() {
            @Override
